...
var _this = this;
var createBtn = function (val, hrefVal, action) {
...
var exe = function () { return __awaiter(_this, void 0, void 0, function () {
    var title, jwt, req, response, payload, payloadObj;
            ...
            case 2:
                ...
                switch (response.status) {
                    ...
                    case 200:
                        ...
                        title.innerHTML = "You are ".concat(payloadObj.sub);
                        createBtn("Sign out", "http://127.0.0.1:4000/file/html?name=sign-in", function () { return localStorage.removeItem("jwt"); });
                }
                _a.label = 3;
            case 3: return [2];
        }
